...
{
    internal class FindByGenresHandler : IRequestHandler<FindByGenres, IEnumerable<AlbumTrack>>
    {
        ...
        public async Task<IEnumerable<AlbumTrack>> Handle(FindByGenres request, CancellationToken cancellationToken)
        {
