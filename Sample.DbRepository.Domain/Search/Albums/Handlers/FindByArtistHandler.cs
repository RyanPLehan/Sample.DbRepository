...
{
    internal class FindByArtistHandler : IRequestHandler<FindByArtist, IEnumerable<Album>>
    {
        ...
        public async Task<IEnumerable<Album>> Handle(FindByArtist request, CancellationToken cancellationToken)
        {
