...
using Sample.DbRepository.Domain.Aggregate;
...
namespace Sample.DbRepository.Infrastructure.Repositories.Aggregate
{
    internal sealed class TrackRepository : ITrackRepository
    {
        ...
        private readonly IContextFactory<AggregateContext> _contextFactory;

        public TrackRepository(IContextFactory<AggregateContext> contextFactory)
        {
